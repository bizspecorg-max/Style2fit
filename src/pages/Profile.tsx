    ...
    <div className="max-w-2xl mx-auto space-y-6 p-4 md:p-6">
        ...
        <CardContent className="space-y-3">
          ...
          {!isActive && (isTrialValid || subscription?.status === "trial") && (
            <>
              ...
              <div className="bg-muted p-3 rounded-lg text-sm">
                ...
                <p className="text-xs text-muted-foreground mt-1">Amount: ₦5,000 / month</p>
              </div>
              <Button
          ...
          {isActive && (
            <>
              ...
              <Button onClick={() => setSubscribeModalOpen(true)} variant="outline" className="w-full">
                Renew / Extend (₦5,000)
              </Button>
            </>
          )}
      ...
      {paymentConfirmed && (
        <Card className="border-green-200 bg-green-50">
          <CardHeader>
            <CardTitle className="text-green-700">✓ Payment notification sent</CardTitle>
            <CardDescription>
              We have received your confirmation. We will update your account shortly.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-sm">
              For faster activation, please send a message to our support team with your email address.
            </p>
            <Button
      ...
      {/* Subscription payment modal – responsive on mobile */}
        ...
        <DialogContent className="w-[calc(100%-2rem)] max-w-md mx-auto rounded-lg">
          ...
          <div className="space-y-4">
            <div className="bg-muted p-4 rounded-lg">
              ...
              <p className="text-sm mt-1">Account name: <strong>Style2Fit</strong></p>
              <p className="text-sm">Amount: <strong>₦5,000</strong> (monthly)</p>
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-2 mt-4">
            <Button variant="outline" onClick={() => setSubscribeModalOpen(false)} className="sm:flex-1">
              Cancel
            </Button>
            <Button onClick={handlePaymentConfirmed} className="bg-green-600 hover:bg-green-700 sm:flex-1">
              I have made payment
            </Button>
          </DialogFooter>
        </DialogContent>
